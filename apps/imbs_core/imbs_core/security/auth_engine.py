"""
IMBS Enterprise Authentication Engine
======================================
...
def get_totp_uri(secret: str, email: str, issuer: str = "IMBS ERP") -> str:
...
def _init_default_users():
    ...
    if "admin" not in _user_by_username:
        ...
        admin = User(
            id=admin_id,
            email="admin@imbs.dev",
            username="admin",
            password_hash=hash_password("Admin@IMBS2026"),
            role="super_admin",
            is_active=True,
            is_verified=True,
        ...
        _user_by_email["admin@imbs.dev"] = admin_id
        ...
        _user_by_email["analyst@imbs.dev"] = analyst_id
